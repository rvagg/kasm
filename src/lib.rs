...
//!
//! kasm is a complete WebAssembly implementation: binary parser, text format
...
//!
//! ```
//! use kasm::{Store, Value, ImportObject};
//! use std::sync::Arc;
//!
//! let mut store = Store::new();
